 ...
 *
 * $Id: nvram_linux.c,v 1.1.1.1 2016/01/18 09:09:58 bcmac Exp $
 */
...
printk("nvram_mtd->erasesize -> %08x nvram_space -> %08x offset -> %08x header->len -> %08x\n", nvram_mtd->erasesize, nvram_space,offset, header->len );
